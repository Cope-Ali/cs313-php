...
<div class="item" id="fluffer">
    ...
    <input type="submit" class="button" name="flufferbutt">
    <button type="button" onclick="<?php addCart(1) ?>"> Add to Cart </button>
</div>
...
<div class="item" id="princess"> 
    ...
    <button type="button" onclick="addCart('Princess Snow White')"> Add to Cart </button>
</div>
...
<div class="item" id="houdini">
    ...
    <button type="button" onclick="addCart('Houdini')"> Add to Cart </button>
</div>
...
<div class="item" id="Roxi">
    ...
    <button type="button" onclick="addCart('Roxi')"> Add to Cart </button>
</div>
<div class="checkout">
